	...
	return (
		<>
			<button
				...
				type="button"
				className={`visible fixed right-12 top-2 z-40 order-10 block h-10 w-10 self-center rounded bg-white opacity-100 lg:hidden ${
					isSideNavOpen
			...
			>
				<a
					aria-label="Wialon logo"
					className="flex items-center gap-2 whitespace-nowrap p-6 pl-14 pt-4  border-b text-xl font-medium focus:outline-none"
					href="javascript:void(0)"
				>
					<Image src="/wialon-logo.jpg" width={50} height={50} />
					{/* <svg
						width="300"
						height="300"
						viewBox="0 0 300 300"
